...
{
    public sealed class SampleCharacterAttackRDef : SampleCharacterCardTemplate
    {
    ...
    [EntityLogic(typeof(SampleCharacterAttackRDef))]
    public sealed class SampleCharacterAttackR : SampleCharacterCard
    {
